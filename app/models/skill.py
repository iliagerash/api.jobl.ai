...
class Skill(Base):
    ...
    uri = Column(String(36), primary_key=True)  # UUID extracted from ESCO conceptUri
...
class SkillLabel(Base):
    ...
    skill_uri = Column(String(36), ForeignKey("skills.uri", ondelete="CASCADE"), primary_key=True)
